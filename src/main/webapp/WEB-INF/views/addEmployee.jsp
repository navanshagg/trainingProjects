...
<td>${e.doj}</td>
<td>${e.pan}</td>
<td><a href="${pageContext.servletContext.contextPath}/edit/${e.employeeId}"> <input type="button"  class="btn btn-success"  value="EDIT"></a></td>
<td><a href="${pageContext.servletContext.contextPath}/delete?employeeId=${e.employeeId}"> <input type="button"  class="btn btn-danger"  value="DELETE"></a></td>
</tr>
</c:forEach>
</tbody>
</table>
